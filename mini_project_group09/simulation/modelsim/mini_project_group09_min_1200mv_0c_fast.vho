...
-- Equation(s):
-- \inst|SYNC|red_out~0_combout\ = (\inst|SYNC|video_on_v~q\ & \inst|SYNC|video_on_h~q\)
...
-- Equation(s):
-- \inst|LessThan14~0_combout\ = (!\inst1|cursor_column\(9) & (((!\inst1|cursor_column\(6)) # (!\inst1|cursor_column\(8))) # (!\inst1|cursor_column\(7))))
...
-- Equation(s):
-- \inst1|RECV_UART~0_combout\ = (!\inst1|cursor_column\(8) & (!\inst1|cursor_column\(9) & !\inst1|cursor_column\(7)))
...
-- Equation(s):
-- \inst|SYNC|process_0~8_combout\ = (!\inst|SYNC|v_count\(7) & (!\inst|SYNC|v_count\(8) & (!\inst|SYNC|v_count\(6) & !\inst|SYNC|v_count\(10))))
...
-- Equation(s):
-- \inst|SYNC|process_0~9_combout\ = (\inst|SYNC|v_count\(10) & (((!\inst|SYNC|process_0~8_combout\)) # (!\inst|SYNC|process_0~7_combout\))) # (!\inst|SYNC|v_count\(10) & (\inst|SYNC|v_count\(9) & ((!\inst|SYNC|process_0~8_combout\) # 
-- (!\inst|SYNC|process_0~7_combout\))))
...
-- Equation(s):
-- \inst|SYNC|Equal0~0_combout\ = (\inst|SYNC|h_count\(1) & (\inst|SYNC|h_count\(4) & (\inst|SYNC|h_count\(0) & \inst|SYNC|h_count\(3))))
...
-- Equation(s):
-- \inst|bullet_Y_motion[4]~0_combout\ = (\inst|bullet_Y_pos\(4)) # ((\inst|bullet_Y_pos\(3) & ((\inst|bullet_Y_pos\(2)) # (\inst|bullet_Y_pos\(1)))))
...
-- Equation(s):
-- \inst7|Equal0~6_combout\ = (!\inst7|i\(20) & (!\inst7|i\(22) & (!\inst7|i\(21) & !\inst7|i\(23))))
...
-- Equation(s):
-- \inst7|Equal0~5_combout\ = (!\inst7|i\(17) & (!\inst7|i\(16) & (!\inst7|i\(18) & !\inst7|i\(19))))
...
-- Equation(s):
-- \inst|bullet_Y_pos[2]~12_combout\ = (\inst|bullet_Y_pos\(2) & ((\inst|bullet_Y_motion\(4) & (\inst|bullet_Y_pos[1]~11\ & VCC)) # (!\inst|bullet_Y_motion\(4) & (!\inst|bullet_Y_pos[1]~11\)))) # (!\inst|bullet_Y_pos\(2) & ((\inst|bullet_Y_motion\(4) & 
-- (!\inst|bullet_Y_pos[1]~11\)) # (!\inst|bullet_Y_motion\(4) & ((\inst|bullet_Y_pos[1]~11\) # (GND)))))
-- \inst|bullet_Y_pos[2]~13\ = CARRY((\inst|bullet_Y_pos\(2) & (!\inst|bullet_Y_motion\(4) & !\inst|bullet_Y_pos[1]~11\)) # (!\inst|bullet_Y_pos\(2) & ((!\inst|bullet_Y_pos[1]~11\) # (!\inst|bullet_Y_motion\(4)))))
...
-- Equation(s):
-- \inst|bullet_Y_pos[4]~16_combout\ = (\inst|bullet_Y_motion\(4) & ((\inst|bullet_Y_pos\(4) & (\inst|bullet_Y_pos[3]~15\ & VCC)) # (!\inst|bullet_Y_pos\(4) & (!\inst|bullet_Y_pos[3]~15\)))) # (!\inst|bullet_Y_motion\(4) & ((\inst|bullet_Y_pos\(4) & 
-- (!\inst|bullet_Y_pos[3]~15\)) # (!\inst|bullet_Y_pos\(4) & ((\inst|bullet_Y_pos[3]~15\) # (GND)))))
-- \inst|bullet_Y_pos[4]~17\ = CARRY((\inst|bullet_Y_motion\(4) & (!\inst|bullet_Y_pos\(4) & !\inst|bullet_Y_pos[3]~15\)) # (!\inst|bullet_Y_motion\(4) & ((!\inst|bullet_Y_pos[3]~15\) # (!\inst|bullet_Y_pos\(4)))))
...
-- Equation(s):
-- \inst|bullet_Y_pos[5]~18_combout\ = ((\inst|bullet_Y_motion\(4) $ (\inst|bullet_Y_pos\(5) $ (!\inst|bullet_Y_pos[4]~17\)))) # (GND)
-- \inst|bullet_Y_pos[5]~19\ = CARRY((\inst|bullet_Y_motion\(4) & ((\inst|bullet_Y_pos\(5)) # (!\inst|bullet_Y_pos[4]~17\))) # (!\inst|bullet_Y_motion\(4) & (\inst|bullet_Y_pos\(5) & !\inst|bullet_Y_pos[4]~17\)))
...
-- Equation(s):
-- \inst|bullet_Y_pos[7]~22_combout\ = ((\inst|bullet_Y_pos\(7) $ (\inst|bullet_Y_motion\(4) $ (!\inst|bullet_Y_pos[6]~21\)))) # (GND)
-- \inst|bullet_Y_pos[7]~23\ = CARRY((\inst|bullet_Y_pos\(7) & ((\inst|bullet_Y_motion\(4)) # (!\inst|bullet_Y_pos[6]~21\))) # (!\inst|bullet_Y_pos\(7) & (\inst|bullet_Y_motion\(4) & !\inst|bullet_Y_pos[6]~21\)))
...
-- Equation(s):
-- \inst|bullet_Y_pos[9]~26_combout\ = ((\inst|bullet_Y_pos\(9) $ (\inst|bullet_Y_motion\(4) $ (!\inst|bullet_Y_pos[8]~25\)))) # (GND)
-- \inst|bullet_Y_pos[9]~27\ = CARRY((\inst|bullet_Y_pos\(9) & ((\inst|bullet_Y_motion\(4)) # (!\inst|bullet_Y_pos[8]~25\))) # (!\inst|bullet_Y_pos\(9) & (\inst|bullet_Y_motion\(4) & !\inst|bullet_Y_pos[8]~25\)))
...
-- Equation(s):
-- \inst|bullet_Y_pos[10]~28_combout\ = \inst|bullet_Y_motion\(4) $ (\inst|bullet_Y_pos[9]~27\ $ (\inst|bullet_Y_pos\(10)))
...
-- Equation(s):
-- \inst|bullet_Y_motion[4]~1_combout\ = (\inst|bullet_Y_pos\(5) & (((\inst|bullet_Y_pos\(4) & \inst|bullet_Y_pos\(3))) # (!\inst|bullet_Y_pos\(8))))
...
-- Equation(s):
-- \inst|bullet_Y_motion[4]~2_combout\ = (\inst|bullet_Y_pos\(6) & (\inst|bullet_Y_motion[4]~1_combout\ & ((\inst|bullet_Y_motion[4]~0_combout\) # (\inst|bullet_Y_pos\(8)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|bullet_Y_motion[4]~0_combout\,
...
-- Equation(s):
-- \inst|bullet_Y_motion[4]~3_combout\ = (\inst|bullet_Y_pos\(8) & ((\inst|bullet_Y_motion\(4)) # ((\inst|bullet_Y_pos\(7)) # (\inst|bullet_Y_motion[4]~2_combout\)))) # (!\inst|bullet_Y_pos\(8) & (\inst|bullet_Y_motion\(4) & ((\inst|bullet_Y_pos\(7)) # 
...
-- Equation(s):
-- \inst|bullet_Y_motion[4]~4_combout\ = (\inst|bullet_Y_pos\(10)) # ((\inst|bullet_Y_pos\(9)) # (\inst|bullet_Y_motion[4]~3_combout\))
...
-- Equation(s):
-- \inst|SYNC|LessThan7~0_combout\ = (\inst|SYNC|v_count\(7) & (\inst|SYNC|v_count\(8) & (\inst|SYNC|v_count\(6) & \inst|SYNC|v_count\(5))))
...
-- Equation(s):
-- \inst|SYNC|Add1~20_combout\ = \inst|SYNC|v_count\(10) $ (!\inst|SYNC|Add1~19\)
...
PORT MAP (
	...
	datab => \inst|SYNC|Add1~20_combout\,
...
-- Equation(s):
-- \inst|SYNC|LessThan7~1_combout\ = (!\inst|SYNC|v_count\(9) & (!\inst|SYNC|LessThan7~0_combout\ & !\inst|SYNC|v_count\(10)))
...
-- Equation(s):
-- \inst|LessThan10~3_cout\ = CARRY((\inst|SYNC|pixel_row\(2) & (!\inst|bullet_Y_pos\(2) & !\inst|LessThan10~1_cout\)) # (!\inst|SYNC|pixel_row\(2) & ((!\inst|LessThan10~1_cout\) # (!\inst|bullet_Y_pos\(2)))))
...
-- Equation(s):
-- \inst|bullet_on~4_combout\ = (\inst|SYNC|pixel_column\(9)) # ((\inst|Add8~14_combout\) # ((\inst|bullet_on~3_combout\) # (\inst|Add11~14_combout\)))
...
-- Equation(s):
-- \inst|bullet_on~6_combout\ = (\inst|LessThan10~16_combout\) # ((\inst|bullet_on~5_combout\) # ((\inst|LessThan11~16_combout\ & !\inst|Add11~12_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|LessThan11~16_combout\,
	datab => \inst|Add11~12_combout\,
	datac => \inst|LessThan10~16_combout\,
...
-- Equation(s):
-- \inst|player_X_pos[0]~33_combout\ = (\inst|player_X_pos\(3) & (\inst|player_X_pos\(6) & (\inst|player_X_pos\(5) & \inst|player_X_pos\(4))))
...
-- Equation(s):
-- \inst|player_X_pos[0]~38_combout\ = (\inst|player_X_pos\(9) & ((\inst|player_X_pos\(7)) # ((\inst|player_X_pos\(8)) # (\inst|player_X_pos[0]~33_combout\))))
...
PORT MAP (
	dataa => \inst|player_X_pos\(7),
	datab => \inst|player_X_pos\(8),
	datac => \inst|player_X_pos[0]~33_combout\,
...
-- Equation(s):
-- \inst1|PACKET_CHAR1[0]~3_combout\ = (\inst1|PACKET_COUNT\(1)) # (!\inst1|PACKET_COUNT\(0))
...
PORT MAP (
	clk => \inst1|MOUSE_CLK_FILTER~clkctrl_outclk\,
	d => \inst1|PACKET_CHAR1[0]~3_combout\,
	ena => \inst1|PACKET_CHAR2[7]~4_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \inst1|PACKET_CHAR2[7]~3_combout\ = (!\inst1|LessThan1~0_combout\ & (\inst1|PACKET_CHAR2[7]~2_combout\ & (\inst1|READ_CHAR~q\ & \inst1|INCNT[3]~0_combout\)))
...
-- Equation(s):
-- \inst1|cursor_column[9]~8_combout\ = (!\inst1|LessThan1~0_combout\ & (\inst1|READ_CHAR~q\ & (!\inst1|PACKET_COUNT\(1) & \inst1|INCNT[3]~0_combout\)))
...
-- Equation(s):
-- \inst1|cursor_column[8]~6_combout\ = (\inst1|RECV_UART~1_combout\ & (!\inst1|new_cursor_column\(8) & (!\inst1|new_cursor_column\(0) & \inst1|RECV_UART~2_combout\)))
...
-- Equation(s):
-- \inst1|cursor_column[8]~19_combout\ = ((\inst1|cursor_column[8]~6_combout\) # ((!\inst1|new_cursor_column\(8) & !\inst1|new_cursor_column\(7)))) # (!\inst1|new_cursor_column\(9))
...
-- Equation(s):
-- \inst|LessThan16~1_combout\ = (\inst1|cursor_column\(3)) # ((\inst1|cursor_column\(2)) # ((\inst1|cursor_column\(0)) # (\inst1|cursor_column\(1))))
...
-- Equation(s):
-- \inst|player_X_pos[0]~35_combout\ = (!\inst|player_X_pos\(4) & (!\inst|player_X_pos\(5) & (!\inst|player_X_pos\(8) & !\inst|player_X_pos\(7))))
...
-- Equation(s):
-- \inst|player_X_pos[0]~37_combout\ = (\inst|player_X_pos[0]~36_combout\) # ((\inst1|cursor_column\(8) & ((\inst|LessThan16~1_combout\) # (\inst|LessThan16~0_combout\))))
...
-- Equation(s):
-- \inst|SYNC|red_out~1_combout\ = (\inst|SYNC|pixel_row\(6) & (\inst|SYNC|pixel_row\(5) & !\inst|SYNC|pixel_row\(7))) # (!\inst|SYNC|pixel_row\(6) & (!\inst|SYNC|pixel_row\(5) & \inst|SYNC|pixel_row\(7)))
...
-- Equation(s):
-- \inst|SYNC|v_count~8_combout\ = (\inst|SYNC|process_0~13_combout\ & \inst|SYNC|Add1~4_combout\)
...
-- Equation(s):
-- \inst|SYNC|red_out~3_combout\ = (\inst|SYNC|red_out~1_combout\ & ((\inst|SYNC|red_out~2_combout\ & ((\inst|SYNC|pixel_row\(4)))) # (!\inst|SYNC|red_out~2_combout\ & (!\inst|LessThan7~0_combout\ & !\inst|SYNC|pixel_row\(4)))))
...
PORT MAP (
	...
	datab => \inst|SYNC|red_out~1_combout\,
...
-- Equation(s):
-- \inst|LessThan4~17_cout\ = CARRY((\inst|player_X_pos\(8) & ((!\inst|LessThan4~15_cout\) # (!\inst|Add4~8_combout\))) # (!\inst|player_X_pos\(8) & (!\inst|Add4~8_combout\ & !\inst|LessThan4~15_cout\)))
...
-- Equation(s):
-- \inst|player_on~0_combout\ = (\inst|Add4~12_combout\) # (((\inst|LessThan5~18_combout\) # (\inst|LessThan4~20_combout\)) # (!\inst|SYNC|pixel_row\(8)))
...
PORT MAP (
	...
	datab => \inst|SYNC|pixel_row\(8),
	datac => \inst|LessThan5~18_combout\,
...
PORT MAP (
	dataa => \inst|tank_X_pos\(8),
	datab => \inst|tank_X_motion\(2),
	datac => \inst|tank_X_motion[2]~2_combout\,
...
-- Equation(s):
-- \inst|LessThan0~7_cout\ = CARRY((\inst|tank_X_pos\(4) & (\inst|Add4~0_combout\ & !\inst|LessThan0~5_cout\)) # (!\inst|tank_X_pos\(4) & ((\inst|Add4~0_combout\) # (!\inst|LessThan0~5_cout\))))
...
-- Equation(s):
-- \inst|tank_on~1_combout\ = (\inst|SYNC|pixel_row\(4) & (((\inst|SYNC|pixel_row\(5))) # (!\inst|SYNC|pixel_row\(2)))) # (!\inst|SYNC|pixel_row\(4) & (((\inst|tank_on~0_combout\) # (!\inst|SYNC|pixel_row\(5)))))
...
-- Equation(s):
-- \inst|tank_on~2_combout\ = ((\inst|tank_on~1_combout\) # ((!\inst|SYNC|pixel_row\(3) & !\inst|SYNC|pixel_row\(5)))) # (!\inst|SYNC|pixel_row\(6))
...
-- Equation(s):
-- \inst|tank_on~4_combout\ = (\inst|LessThan1~18_combout\) # ((\inst|Add1~12_combout\) # ((\inst|LessThan0~18_combout\) # (\inst|tank_on~3_combout\)))
...
-- Equation(s):
-- \inst|SYNC|green_out~2_combout\ = (\inst|SYNC|video_on_h~q\ & (\inst|SYNC|video_on_v~q\ & (\inst|tank_on~4_combout\ & \inst|bullet_on~6_combout\)))
...
-- Equation(s):
-- \inst|SYNC|process_0~3_combout\ = (\inst|SYNC|process_0~0_combout\) # ((\inst|SYNC|process_0~2_combout\ & (\inst|SYNC|h_count\(5) & \inst|SYNC|h_count\(6))) # (!\inst|SYNC|process_0~2_combout\ & (!\inst|SYNC|h_count\(5) & !\inst|SYNC|h_count\(6))))
...
-- Equation(s):
-- \inst|SYNC|v_count[9]~1_combout\ = (\inst|SYNC|v_count[4]~0_combout\ & (\inst|SYNC|process_0~13_combout\ & (\inst|SYNC|Add1~18_combout\))) # (!\inst|SYNC|v_count[4]~0_combout\ & (((\inst|SYNC|v_count\(9)))))
...
-- Equation(s):
-- \inst1|PACKET_CHAR1[0]~1_combout\ = (\inst1|INCNT\(3) & \inst1|PACKET_COUNT\(0))
...
-- Equation(s):
-- \inst1|PACKET_CHAR1[0]~0_combout\ = (!\inst1|PACKET_COUNT\(1) & ((\inst1|INCNT\(0)) # ((\inst1|INCNT\(1)) # (\inst1|INCNT\(2)))))
...
-- Equation(s):
-- \inst1|PACKET_CHAR1[0]~2_combout\ = (\inst1|READ_CHAR~q\ & (!\inst1|mouse_state.WAIT_OUTPUT_READY~q\ & (\inst1|PACKET_CHAR1[0]~1_combout\ & \inst1|PACKET_CHAR1[0]~0_combout\)))
...
PORT MAP (
	dataa => \inst1|READ_CHAR~q\,
	datab => \inst1|mouse_state.WAIT_OUTPUT_READY~q\,
	datac => \inst1|PACKET_CHAR1[0]~1_combout\,
...
PORT MAP (
	...
	ena => \inst1|PACKET_CHAR1[0]~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
